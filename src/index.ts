...
export {
    ...
    Document, Page, DocumentFactory, PageFactory, PAGE_FORMATS,
    TextDirection,

    // Font System
    FontSystem, FontWeight, FontStyle, FontCategory, FontUtils, FontCollections,

    // Text Processing (from core)
    TextProcessor,

    // PDF Engine
    PdfStandardFont, PdfFont, FontRegistry
} from './core/index.js';

// Widget exports - Consolidated System
export {
    // Base widgets
    BaseWidget, EmptyWidget, WidgetUtils, WidgetLayoutUtils, PageDefaults,
    ...
    createText, createRichText,

    // Layout widgets
    Container, Stack, Positioned, StackFit, LayoutUtils,
    BorderRadiusUtils, DecorationStyles,
    createContainer, createStack, createPositioned,

    // Flex widgets
    Row, Column, Flex, Flexible, Expanded, FlexUtils,
    createRow, createColumn, createFlexible, createExpanded,

    // Data widgets
    Table, TableRow, Chart, BarChart, LineChart,
    TableColumnWidthType, TableCellVerticalAlignment,
    ChartType, BarOrientation, LineMarker, DataUtils,
    createTable, createTableRow, createChart, createBarChart, createLineChart,
...
export type {
    // Widget types
    Widget, WidgetProps, TextProps, RichTextProps, TextSpan,
    ContainerProps, StackProps, PositionedProps,
    BoxDecoration, Border, BorderRadius, BoxShadow,
    FlexProps, FlexChild,
    TableProps, TableRowProps, ChartProps, BarChartProps, LineChartProps,
    TableColumnWidth, ChartDataPoint, ChartDataSeries,
    MultiPageProps, ContentMeasurement, PageLayout, ContentChunk,
    ThemeProps, DefaultTextStyleProps
} from './widgets/index.js';
