...
describe('System Integration', () => {
                        ...
                        children: [
                            ...
                            new Container({
                                ...
                                child: new TextWidget('Annual Report 2023', {
                                    style: { fontSize: 24, fontWeight: ThemeTypes.FontWeight.Bold }
                                })
                            }),
                                ...
                                child: new Column({
                                    children: [
                                        new TextWidget('Executive Summary', {
                                            style: { fontSize: 18, fontWeight: ThemeTypes.FontWeight.Bold }
                                        }),
                                        LayoutUtils.padded(
                                            new TextWidget('This report presents our company performance for the fiscal year 2023, highlighting key achievements and growth metrics.'),
                                            Layout.EdgeInsets.only({ top: 10, bottom: 20 })
                                        )
                                    ]
                                })
                            }),
                    ...
                    child: new Column({
                        ...
                        children: [
                            new TextWidget('Company Overview', {
                                style: { fontSize: 28, fontWeight: ThemeTypes.FontWeight.Bold }
                            }),
                            LayoutUtils.padded(
                                new TextWidget('Confidential Internal Document', {
                                    style: { fontSize: 14, fontStyle: ThemeTypes.FontStyle.Italic }
                                }),
                            ...
                            new Column({
                                children: [
                                    new TextWidget('Financial Overview', {
                                        style: { fontSize: 20, fontWeight: ThemeTypes.FontWeight.Bold }
                                    }),
                                    LayoutUtils.padded(
                                        new LineChart({
                                            title: 'Revenue Trend',
                                            series: [
                                                DataUtils.arrayToSeries('Monthly Revenue', [95, 102, 108, 115, 122, 118, 125, 130, 128, 135, 142, 150])
                                            ],
                                            height: 250
                                        }),
    ...
    describe('Performance and Scalability', () => {
                ...
                child: new Column({
                    children: Array.from({ length: 50 }, (_, i) =>
                        new Row({
                            children: [
                                FlexUtils.flexible(
                                    new TextWidget(`Row ${i + 1} - Column 1`),
                                    { flex: 1 }
                                ),
                                FlexUtils.flexible(
                                    new Container({
                                        padding: Layout.EdgeInsets.all(5),
                                        child: new TextWidget(`Row ${i + 1} - Column 2`)
                                    }),
                                    { flex: 2 }
                                ),
                                FlexUtils.flexible(
                                    new Stack({
                                        children: [
                                            new TextWidget(`Row ${i + 1} - Column 3`),
                                            new Positioned({
                                                top: 0,
                                                right: 0,
        ...
        it('should maintain consistent layout across multiple renders', () => {
            const widget = new Container({
                ...
                child: new Row({
                    children: [
                        FlexUtils.flexible(new TextWidget('Consistent 1'), { flex: 1 }),
                        FlexUtils.flexible(new TextWidget('Consistent 2'), { flex: 2 }),
                        FlexUtils.flexible(new TextWidget('Consistent 3'), { flex: 1 })
                    ]
                })
            });
    ...
    describe('Error Handling and Robustness', () => {
        ...
        it('should handle extreme constraint scenarios', () => {
            const widget = new TextWidget('Test content for extreme constraints');

            const extremeConstraints = [
                // Very small constraints
                { minWidth: 0, maxWidth: 1, minHeight: 0, maxHeight: 1 },
                // Very large constraints
                { minWidth: 0, maxWidth: 10000, minHeight: 0, maxHeight: 10000 },
                // Tight constraints
            ...
            extremeConstraints.forEach(constraints => {
                ...
                expect(() => {
                    ...
                    expect(layout.size.width).toBeLessThanOrEqual(constraints.maxWidth);
                    expect(layout.size.height).toBeLessThanOrEqual(constraints.maxHeight);
                    expect(layout.size.width).toBeGreaterThanOrEqual(constraints.minWidth);
                    expect(layout.size.height).toBeGreaterThanOrEqual(constraints.minHeight);
                }).not.toThrow();
            });
        });
                        ...
                        children: [
                            ...
                            new Row({
                                ...
                                children: [
                                    ...
                                    new Column({
                                        crossAxisAlignment: FlexTypes.CrossAxisAlignment.End,
                                        children: [
                                            new TextWidget('Invoice #: INV-2023-001'),
                                            new TextWidget('Date: March 15, 2023'),
                                            new TextWidget('Due: April 15, 2023')
                                        ]
                                    })
                                ]
                            }),
                            ...
                            new Row({
                                children: [
                                    FlexUtils.expanded(
                                        new Column({
                                            crossAxisAlignment: FlexTypes.CrossAxisAlignment.Start,
                                            children: [
                                                new TextWidget('From:', { style: { fontWeight: ThemeTypes.FontWeight.Bold } }),
                                                new TextWidget('Your Company Name'),
                                                new TextWidget('123 Business St.'),
                                                new TextWidget('City, State 12345')
                                            ]
                                        })
                                    ),
                                    FlexUtils.expanded(
                                        new Column({
                                            crossAxisAlignment: FlexTypes.CrossAxisAlignment.Start,
                                            children: [
                                                new TextWidget('To:', { style: { fontWeight: ThemeTypes.FontWeight.Bold } }),
                                                new TextWidget('Client Company'),
                                                new TextWidget('456 Client Ave.'),
                                                new TextWidget('Client City, State 67890')
                                            ]
                                        })
                                    )
                                ]
                            ...
                            // Total
                            new Row({
                                mainAxisAlignment: FlexTypes.MainAxisAlignment.End,
                                children: [
                                    new Container({
                                        padding: Layout.EdgeInsets.all(10),
                                        child: new Column({
                                            crossAxisAlignment: FlexTypes.CrossAxisAlignment.End,
                                            children: [
                                                new TextWidget('Subtotal: $5,150'),
                                                new TextWidget('Tax (8.5%): $437.75'),
                                                new TextWidget('TOTAL: $5,587.75', {
                                                    style: { fontSize: 16, fontWeight: ThemeTypes.FontWeight.Bold }
                                                })
                                            ]
                                        })
                                    })
                            ...
                            new Row({
                                ...
                                children: [
                                    new Container({
                                        ...
                                        child: new Column({
                                            children: [
                                                new TextWidget('Revenue', { style: { fontWeight: ThemeTypes.FontWeight.Bold } }),
                                                new TextWidget('$125,000', { style: { fontSize: 20, color: '#2e7d32' } })
                                            ]
                                        })
                                    }),
                                    new Container({
                                        ...
                                        child: new Column({
                                            children: [
                                                new TextWidget('Orders', { style: { fontWeight: ThemeTypes.FontWeight.Bold } }),
                                                new TextWidget('1,247', { style: { fontSize: 20, color: '#1976d2' } })
                                            ]
                                        })
                                    }),
                                    new Container({
                                        ...
                                        child: new Column({
                                            children: [
                                                new TextWidget('Growth', { style: { fontWeight: ThemeTypes.FontWeight.Bold } }),
                                                new TextWidget('+18.5%', { style: { fontSize: 20, color: '#388e3c' } })
                                            ]
                                        })
                                    })
                                ]
                            ...
                            children: [
                                FlexUtils.expanded(
                                    new BarChart({
                                        title: 'Monthly Sales',
                                        series: [
                                            DataUtils.arrayToSeries('Sales', [12, 15, 18, 22, 19, 25])
                                        ],
                                        height: 200
                                    })
                                ),
                                ...
                                FlexUtils.expanded(
                                    new LineChart({
                                        title: 'User Growth',
                                        series: [
                                            DataUtils.arrayToSeries('Users', [1000, 1200, 1100, 1400, 1600, 1500])
                                        ],
                                        height: 200,
                                        fill: true
                                    })
                ...
                new Container({
                    child: new Row({
                        children: [
                            ...
                            FlexUtils.flexible(new TextWidget('Flex content'), { flex: 1 })
                        ]
                    })
                })
            );
