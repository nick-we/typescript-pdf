...
describe('Text Overflow Validation - Fixed Behavior', () => {
    ...
    test('Text wrapping works with different container widths', () => {
        const longText =
            'This is a long text that should wrap differently based on container width';
        ...
        testCases.forEach(({ width, expectedLines }) => {
            ...
            console.log(
                `Width ${width}px: ${actualLines} lines (expected ~${expectedLines})`
            );
    ...
    test('Ellipsis truncation works correctly', () => {
        ...
        console.log(
            `Ellipsis truncation: ${result.size.width}x${result.size.height}`
        );
    ...
    test('maxLines property limits line count', () => {
        ...
        console.log(
            `maxLines=3: ${actualLines} lines, height=${result.size.height}`
        );
    ...
    test('TextOverflow.Visible allows text to exceed bounds', () => {
        ...
        console.log(
            `Visible overflow: ${result.size.width}x${result.size.height}`
        );
    ...
    test('Generate comprehensive text overflow validation PDF', async () => {
        ...
        console.log(
            `✅ Generated text overflow validation PDF: ${pdfBytes.length} bytes`
        );
    ...
    test('Edge cases handled correctly', () => {
        ...
        console.log(
            `Edge case - narrow container: ${narrowResult.size.width}x${narrowResult.size.height}`
        );
    });
});
