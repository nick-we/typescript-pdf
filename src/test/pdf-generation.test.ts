...
import {
    ...
    Table, Chart, BarChart, Theme, PrebuiltThemes,
...
describe('PDF Generation Visual Validation', () => {
    ...
    describe('Container and Layout Tests', () => {
        ...
        it('should generate complex text layouts', async () => {
            const doc = new Document();
            ...
            const outputPath = join(TEST_OUTPUT_DIR, 'text-layouts.pdf');
            writeFileSync(outputPath, pdfBytes);
    ...
    describe('Complex Layout Tests', () => {
        it('should generate complex responsive grid layout', async () => {
            const doc = new Document();
            ...
            const outputPath = join(TEST_OUTPUT_DIR, 'responsive-grid.pdf');
            writeFileSync(outputPath, pdfBytes);
